...
class CurrencyConverterApp:
    ...
    def plot_graph(self):
        ...
        if currency and duration:
            ...
            # Show additional messagebox with USD equivalent
            last_conversion_rate = df[currency].iloc[-1]
            usd_equivalent = 1 / last_conversion_rate
            tk.messagebox.showinfo("USD Equivalent", f"1 {currency} = {last_conversion_rate} USD\nUSD Equivalent: {usd_equivalent:.4f} USD")
